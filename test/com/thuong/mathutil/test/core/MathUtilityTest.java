 ...
 */
package com.thuong.mathutil.test.core;
...
public class MathUtilityTest {
    ...
    //ta sẽ xài làm kiểu well - đưa 5!, 6!, không chơi đưa -5!, 30!
    ...
    public void testGetFactorialGivenRightArgumentReturnsWell() {
        ...
        //hàm giúp so sánh 2 giá trị nào đó có giống hay hay ko
        ...
        Assert.assertEquals(120, MathUtil.getFactorial(6));   //tui muốn 5! = 120
    ...
    //assertEqual() ko dùng thể so sánh 2 ngoại lệ
    //      equals() là bằng nhau hay ko trên value!!!

    
    //MÀU ĐỎ ĐÓ EM, DO HÀM ĐÚNG LÀ CÓ NÉM NGOẠI LỆ THẬT SỰ 
    //              NHƯNG KHÔNG PHẢI NGOẠI LỆ NHƯ KÌ VỌNG - THỰC SỰ KÌ VỌNG SAI
    //              KO PHẢI HÀM NÉM SAI
//    @Test(expected = NumberFormatException.class)
//    public void testGetFactorialGivenWrongArgumentThrowExpection() {
//        MathUtil.getFactorial(-5);  //hàm @Test chạy, hay hàm getF() chạy sẽ phải ném về ngoại lệ NumberFormat...
//    }
...
//    }
    ...
    @Test
    public void testGetFactorialGivenWrongArgumentThrowExpection_LambdaVersion() {
    ...
    @Test
    public void testGetFactorialGivenWrongArgumentThrowExpection_TryCatch() {
